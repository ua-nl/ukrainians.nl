...
export default function Index() {
  ...
  return (
    <Page ctx={ctx}>
      ...
      <Section>
        <IconCardContainer>
          <IconCard Icon={IconHandWithHeart} title="Humanitarian aid">
            <Para>
          ...
          <IconCard Icon={IconCoatOfArms} title="Community services">
            <Para>
              We coordinate and supply priority assistance for those impacted by
              the war, whether within Ukraine or beyond its borders
            </Para>
          ...
          <IconCard Icon={IconUkraineInHands} title="Events and activism">
            <Para>
